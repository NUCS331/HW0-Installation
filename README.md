...
Submit a PDF-file created using the MS Word report template provided. Download the template from here [template file (.docx)](./WordTemplate/Winer_2022_NUCS 331_template.docx) and create your own copy to start your report for homework 0.
